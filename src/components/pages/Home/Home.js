...
const Home = () => {
    return (
        <div className="home has-text-centered">
            ...
            <h2 className="subtitle is-size-3 has-text-primary is-family-code has-text-weight-bold">I'm a Fullstack Web & App Developer, Game Developer and 3D Modeller based in Germany</h2>
